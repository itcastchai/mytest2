...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_175572645";//发送短信验证码
	...
	public static void sendShortMessage(String phoneNumbers,String param) throws ClientException {
		...
		// 替换成你的AK
		final String accessKeyId = "LTAI4FsZYJG7sd5ecguHiRSN";// 你的accessKeyId,参考本文档步骤2
		final String accessKeySecret = "VLXvW1i3JAzwl8hr2I0AGtV1LMOAmc";// 你的accessKeySecret，参考本文档步骤2
